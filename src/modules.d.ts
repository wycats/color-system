...
declare module "apca-w3" {
   ...
   * float. When set to 0 or more, rounds the result to that many decimal
   * places.
   *
  ...
  /**
   * @param [rgb]
   * A tuple of numbers representing the red, green, and blue components
   * (0.0-1.0) of a color in the p3 display color space
   *
   * @returns
   * The linear Y (luminance) of the given rgba color (+0.0-1.1)
   */
   ...
   *
   * @param [rgbBG]
   * The background color expressed as a tuple of red, green, and blue
   * components (0-255).
   * Defaults to `[0, 0, 0]`.
   *
   * @param [isInt]
